...
#pragma warning(disable : 4250) // inheriting methods via dominance
    ...
    public:
        MatchProcessor(::std::shared_ptr<MatchIf> iface) : iface_(iface)
        {
    ...
    {
    public:
        MatchProcessorFactory(const ::std::shared_ptr<MatchIfFactory> &handlerFactory) noexcept : handlerFactory_(handlerFactory) {}
