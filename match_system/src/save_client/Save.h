...
#pragma warning(disable : 4250) // inheriting methods via dominance
    ...
    public:
        SaveProcessor(::std::shared_ptr<SaveIf> iface) : iface_(iface)
        {
    ...
    {
    public:
        SaveProcessorFactory(const ::std::shared_ptr<SaveIfFactory> &handlerFactory) noexcept : handlerFactory_(handlerFactory) {}
